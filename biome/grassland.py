...
# This module is responsible for creating the Grassland parent class which inherits from IContainsAnimals, IContainsPlants, Identifiable and Biome. It has methods for checking whether the biome is at capacity.
