...
# This module is responsible for creating the River parent class which inherits from IContainsAnimals, IContainsPlants, Identifiable and Biome. It has methods for checking whether the biome is at capacity.
...
# River inherits from IContainsAnimals, IContainsPlants, Identifiable and Biome. IContainsAnimals and IContainsPlants are set with the maximum number of occupants they can accept. Identifiable gives each instance a unique uuid.
